...
seoulEastGeohash = ['wydm3', 'wydjz', 'wydq0', 'wydmb', 'wydm8', 'wydmc', 'wydm9' 'wydq6']    #대략 서울 서부 지역 geohash 값
...
zigBangHouseInfo_tbl.to_csv('./매물 정보(위도경도 포함)_강남강북1.csv', encoding = 'cp949', mode = 'w', index = True)